...
namespace SyncChannel.Tasks
{
    ...
    /// </summary>
    public class SyncChannelTask : IScheduledTask
    {
        private readonly ILibraryManager libraryManager;
        private readonly IFileSystem fileSystem;
        private readonly ILogger logger;

        public SyncChannelTask(ILibraryManager libraryManager, IFileSystem fileSystem, ILogManager logManager)
        {
            this.libraryManager = libraryManager;
            this.fileSystem = fileSystem;
            this.logger = logManager.GetLogger("SyncChannel");
        }

        public string Name => "Copy Posters to Folder Images";

        public string Key => "SyncChannelTask";
