    ...
    ILogger logger)
            ...
            IReadOnlyDictionary<string, CachedChannelItem> priorByStableId)
        {
            ...
            return new CachedChannelItem
            {
                ...
                Album = item.Album,
                CatalogueArtist = item.CatalogueArtist,
                CatalogueArtistOverview = item.CatalogueArtistOverview,
                CatalogueArtistPosterUrl = item.CatalogueArtistPosterUrl,
                AlbumOverview = item.AlbumOverview,
                AlbumPosterUrl = item.AlbumPosterUrl,
